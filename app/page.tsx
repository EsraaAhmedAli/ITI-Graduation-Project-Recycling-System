    ...
    <>
      ...
      <section className="flex flex-col md:flex-row justify-between items-stretch gap-6 px-4 py-10 text-2xl bg-base-100 text-center rounded-2xl mx-15">
        <div className="flex-1 flex flex-col items-center">
          <UploadCloud className="w-10 h-10 text-green-600 mx-auto md:mx-0 mb-2" />
          <h2 className="font-bold text-primary mb-2">Easy to Use</h2>
          <p>Upload waste in seconds</p>
        </div>
        <div className="flex-1 flex flex-col items-center">
          <Search className="w-10 h-10 text-blue-600 mx-auto md:mx-0 mb-2" />
          <h2 className="font-bold text-info mb-2">Track Items</h2>
          <p>View recycling activity anytime</p>
        </div>
        <div className="flex-1 flex flex-col items-center">
          <Users className="w-10 h-10 text-yellow-600 mx-auto md:mx-0 mb-2" />
          <h2 className="font-bold text-yellow-600 mb-2">Community</h2>
          <p>Connect with other recyclers</p>
        </div>
      </section>
