...
const ItemSkeleton = memo(() => (
  <div className="animate-pulse rounded-2xl border overflow-hidden" style={{ 
    borderColor: 'var(--border-color)', 
    backgroundColor: 'var(--color-card)' 
  }}>
    <div className="h-40 w-full" style={{ backgroundColor: 'var(--color-base-300)' }} />
    <div className="p-4">
      <div className="h-4 rounded mb-2" style={{ backgroundColor: 'var(--color-base-300)' }} />
      <div className="h-4 rounded w-3/4 mb-3" style={{ backgroundColor: 'var(--color-base-300)' }} />
      <div className="flex justify-between items-center mb-3">
        <div className="h-6 w-16 rounded-lg" style={{ backgroundColor: 'var(--color-base-300)' }} />
        <div className="h-4 w-12 rounded" style={{ backgroundColor: 'var(--color-base-300)' }} />
      </div>
      <div className="h-10 rounded-xl w-full" style={{ backgroundColor: 'var(--color-base-300)' }} />
    </div>
  </div>
));
...
const ItemCard = memo(({ 
  ...
  return (
    <article
      ...
      onMouseEnter={(e) => {
        e.currentTarget.style.boxShadow = '0 10px 15px -3px rgba(16, 185, 129, 0.1), 0 4px 6px -2px rgba(16, 185, 129, 0.05)';
      }}
      onMouseLeave={(e) => {
    ...
    >
      ...
      <div className="p-4 h-32 flex flex-col justify-between">
        <div>
          ...
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="text-end">
              <span className="text-base font-bold" style={{ color: 'var(--text-gray-900)' }}>
                {computedValues.priceDisplay.value}
              </span>
              <span className="text-xs ml-1" style={{ color: 'var(--text-gray-600)' }}>
        ...
        <button
          ...
          onMouseEnter={(e) => {
            if (!isLoading) {
              e.currentTarget.style.background = 'linear-gradient(to right, var(--color-green-600), var(--color-secondary))';
            }
          }}
          onMouseLeave={(e) => {
            if (!isLoading) {
              ...
              style={{
                ...
                backgroundColor: pageNum === currentPage 
                  ...
                  : pageNum === "..." 
                    ? 'transparent'
                    : 'var(--color-card)',
                borderColor: pageNum === currentPage 
                  ? 'var(--color-primary)'
                  : 'var(--border-color)',
      ...
      <div className="min-h-screen flex items-center justify-center"
        ...
        <div className="text-center">
          <div className="w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6"
            ...
            <Recycle className="w-10 h-10" style={{ color: 'var(--color-error)' }} />
          </div>
          <h2 className="text-xl font-semibold mb-2" style={{ color: 'var(--text-gray-900)' }}>
          ...
          {!isLoading && data.length === 0 && (
            <div className="text-center py-12" role="status">
              <div className="w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6"
                ...
                <Recycle className="w-10 h-10" style={{ color: 'var(--text-gray-400)' }} />
              </div>
