...
const trackingSteps = [
  ...
  { id: "enroute", label: "En Route", description: "Driver is heading to your location", icon: Truck },
  { id: "arrived", label: "Arrived", description: "Driver has arrived at pickup location", icon: MapPin },
