  ...
  if (!clientSecret) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
        <div className="flex flex-col items-center justify-center bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl border border-green-100 p-6 sm:p-8 w-full max-w-md">
          <div className="relative">
            <div className="h-12 sm:h-16 mb-4 sm:mb-6 relative">
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row bg-white rounded-2xl shadow-lg border border-green-100 overflow-hidden min-h-[600px]">
          {/* Left Side - Static Illustration - Hidden on mobile, shown on large screens */}
          <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-teal-50 via-green-50 to-emerald-100 items-center justify-center p-8 relative overflow-hidden">
          ...
          {/* Right Side - Payment Form - Full width on mobile, half on large screens */}
          <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-6 lg:p-8">
            <div className="w-full max-w-md">
              {/* Mobile Order Summary - Only shown on small screens */}
              <div className="lg:hidden bg-gradient-to-r from-teal-50 to-green-50 rounded-lg p-4 mb-6 border border-green-100">
                ...
                {paymentMethod === "card" ? (
                  ...
                  >
                    <div className="space-y-3 sm:space-y-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors text-sm sm:text-base"
                      ...
                      <div>
                        ...
                        <select className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors text-sm sm:text-base">
                          <option>Egypt</option>
                        ...
                        <PaymentElement
                          options={{
                            ...
                            defaultValues: {
                              billingDetails: {
                                email:
                                  localCheckoutData?.user.email ||
                                  user?.email ||
                                  "",
                                name:
                                  localCheckoutData?.user.name ||
                                  user?.name ||
                                  "",
                                address: {
                                  line1: localCheckoutData
                                    ? `${localCheckoutData.selectedAddress.street}, ${localCheckoutData.selectedAddress.building}`
                                    : "",
                                  city:
                                    localCheckoutData?.selectedAddress.city ||
                                    "",
                                },
                              },
                            },
                    ...
                    <Button
                      ...
                      className="w-full disabled:opacity-50 bg-green-700 disabled:cursor-not-allowed text-white font-semibold py-3 sm:py-4 px-4 sm:px-6 rounded-lg transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98] shadow-lg hover:shadow-xl text-sm sm:text-base"
                    >
                      {loading ? (
                  ...
                  <div className="space-y-4 sm:space-y-6">
                    ...
                    <Button
                      ...
                      className="w-full disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold py-3 sm:py-4 px-4 sm:px-6 rounded-lg transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98] shadow-lg hover:shadow-xl text-sm sm:text-base"
                    >
                      {loading ? (
                        <div className="flex items-center justify-center space-x-2">
                          <div className="w-4 h-4 sm:w-5 sm:h-5 border-2 border-white border-t-transparent rounded-full animate-spin"></div>
                    ...
                    <div className="text-center">
                      <div className="flex items-center justify-center space-x-2 text-xs text-gray-500">
                        ...
                        <span className="text-center leading-tight">
                          Your order is secured with our privacy policy
                        </span>
                      </div>
                    </div>
                  </div>
