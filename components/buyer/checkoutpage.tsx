...
const CheckoutPage = ({ amount, checkoutData }: CheckoutPageProps) => {
  ...
  const [localCheckoutData, setLocalCheckoutData] = useState<CheckoutData | null>(checkoutData || null);
  ...
  const handlePaymentSuccess = async () => {
    ...
    try {
      ...
      router.push(`/payment/success?payment=completed&amount=${amount}&total=${localCheckoutData.totalPrice}`);
      } else {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!localCheckoutData) {
      setErrorMessage("Order information missing. Please restart the checkout process.");
      setLoading(false);
      return;
    }
            ...
            <div className="bg-slate-800 rounded-[2.5rem] p-3 shadow-2xl transform rotate-2 hover:rotate-0 transition-transform duration-500">
              <div className="bg-white rounded-[2rem] p-6 h-[400px] relative overflow-hidden">
                ...
                <div className="flex items-center mb-6">
                  ...
                  <span className="text-gray-600 font-medium">Payment Data</span>
                </div>
                
                {/* Total Price */}
                <div className="mb-6">
                  <div className="text-gray-600 text-sm mb-1">Total price</div>
                  <div className="text-3xl font-bold text-teal-600">EGP {amount}</div>
                </div>
                
                {/* Payment Method */}
                <div className="mb-4">
                  <div className="text-gray-600 text-sm mb-3">Payment method</div>
                  <div className="bg-slate-700 rounded-xl p-4 text-white relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="text-lg tracking-wider">1234 5678 9012 3456</div>
                ...
                <div className="flex items-center justify-between mb-4">
                  <span className="text-gray-600 text-sm">Save card number</span>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    type="text"
                    defaultValue={localCheckoutData ? `${localCheckoutData.selectedAddress.street}, ${localCheckoutData.selectedAddress.building}` : ""}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors"
              ...
              <Button
                type="submit"
                disabled={!stripe || loading || isCreatingOrder || paymentSuccessful || !localCheckoutData}
