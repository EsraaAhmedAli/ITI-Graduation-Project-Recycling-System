...
function DynamicTable<T extends { [key: string]: any; id?: string | number }>({
  ...
  const renderMobileCard = (item: T, index: number) => {
    ...
    return (
      <div key={index} className="bg-white border border-green-100 rounded-lg mb-4 shadow-sm">
        <div className="p-4">
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-green-100">
      ...
      <div className="p-4 md:p-6 border-b border-green-100 bg-gradient-to-r from-green-50 to-emerald-50">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <h1 className="text-xl md:text-2xl font-semibold text-green-800">{title}</h1>
      ...
      {/* Desktop Table View */}
      <div className="hidden md:block overflow-x-auto" onClick={() => setOpenMenuId(null)}>
