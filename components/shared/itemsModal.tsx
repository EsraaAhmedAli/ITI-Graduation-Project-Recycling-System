...
export default function ItemsModal({
  ...
  const count =
    selectedOrderItems?.reduce((sum, item) => sum + (item.quantity || 0), 0) ||
    0;
  ...
  const total =
    selectedOrderItems?.reduce(
      (sum, item) =>
        sum + priceWithMarkup(item.price || 0, userRole) * (item.quantity || 0),
      0
    ) || 0;
              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between">
                    <div
                      className={isOutOfStock ? "flex-1  opacity-80" : "flex-1"}
                    >
                          ...
                          <>
                              ...
                              <div className="flex items-center gap-2 mb-2">
                                ...
                                >
                                  <path
                                    ...
                                    strokeLinejoin="round"
                                    strokeWidth={2}
                                    d="M7 4V2a1 1 0 011-1h8a1 1 0 011 1v2h4a1 1 0 010 2h-1v12a2 2 0 01-2 2H6a2 2 0 01-2-2V6H3a1 1 0 110-2h4z"
                                  />
                                </svg>
                                <p className="text-xs font-medium text-gray-500 uppercase tracking-wide">
                                  {t("itemsModal.OriginalQuantity")}
                                </p>
                              </div>
                            ...
                            <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-100">
                              <div className="flex items-center gap-2 mb-2">
                                ...
                                <p className="text-xs font-medium text-gray-500 uppercase tracking-wide">
                                  {t("itemsModal.quantityByDelivery")}
                                </p>
                              </div>
                              <p
