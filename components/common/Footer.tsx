...
export default function Footer() {
  ...
  return (
    ...
    color: "var(--foreground)",
  }}className="text-xl font-bold text-gray-800 dark:text-white">{t('footer.title')}</h2>
            </div>
          ...
          <div>
            ...
            <h3 style={{
              color: "var(--foreground)",
            }} className="font-semibold text-gray-800 dark:text-white mb-4">{t('footer.quickLinks')}</h3>
          ...
          <div>
            <h3 style={{
              color: "var(--foreground)",
            }} className="font-semibold text-gray-800 dark:text-white mb-4">{t('footer.support')}</h3>
            <ul className="space-y-3">
              <li>
                <Link
                  href="/contact-us"
          ...
          <div>
            ...
            <h3 style={{
              color: "var(--foreground)",
            }} className="font-semibold text-gray-800 dark:text-white mb-4">{t('footer.contact')}</h3>
