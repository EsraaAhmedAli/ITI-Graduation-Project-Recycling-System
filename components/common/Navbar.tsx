      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between">
        ...
        <div className="flex justify-between h-16 items-center">
          <div className="flex items-center space-x-6">
            <Link
              href="/"
              className="text-gray-700 hover:text-primary transition-colors duration-200 font-extrabold"
            >
              Home
            </Link>
            <Link
            ...
            <Link
              href="/auth"
              className="px-4 py-2 rounded-lg text-gray-700 hover:bg-gray-100 transition-colors duration-200 font-extrabold"
            >
              Login
            </Link>
            <Link
              href="/auth"
              className="px-4 py-2 rounded-lg bg-green-500 hover:bg-green-600 text-white font-semibold transition-colors duration-200"
            >
              Start Recycling
            </Link>
          </div>
