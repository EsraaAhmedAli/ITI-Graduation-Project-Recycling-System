        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-0 min-[375px]:gap-1 sm:gap-2 flex-shrink-0">
            ...
            <div className="relative" ref={cartRef}>
              ...
              {/* Cart Dropdown */}
              {isCartOpen && (
                               <div className="absolute end-[-70px] mt-2 w-72 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-2 z-50">
